...
$password = $_POST['password'];
    ...
    if(!empty($first_name) && !empty($last_name) && !empty($email) && !empty($tel) && !empty($gender) && !empty($age) && !empty($score) && !empty($comments) && !empty($password)){
        ...
        $stmt = $pdo->prepare("INSERT INTO users(id,first_name,last_name,email,tel,gender,age,score,comments,password,registration_date) VALUES(NULL,:first_name,:last_name,:email,:tel,:gender,:age,:score,:comments,:password,sysdate())");
