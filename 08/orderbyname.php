...
//Define query:
$stmt = $pdo->prepare("SELECT last_name, first_name,gender,age, email, score, comments, DATE_FORMAT(registration_date, '%M %d,%Y %T') AS dr, DATE_FORMAT(update_date, '%M %d,%Y %T') AS dr1, id FROM users ORDER BY update_date DESC");
...
if($num > 0 ){
    ...
    echo "<p><a href='output_data.php'><b>登録日順に並び替える</b></a></p>";
