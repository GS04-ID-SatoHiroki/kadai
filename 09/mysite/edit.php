...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $update = db() ->prepare("UPDATE users SET first_name=:e_fname, last_name=:e_lname, email=:e_email, score=:e_score, comments=:e_comments, update_date=sysdate() WHERE id=:id");
...
<?php $title = "編集"; include("html_start.php") ;?>
    <h1>レコード編集</h1>
